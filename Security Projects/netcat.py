...
def client_handler(client_socket):
    ...
    # Now we start another loop if a command shell was requested
    if command:
...
def usage():
    ...
    print(
    "-u --upload=upload_destination - upon receiving connection upload a file"
