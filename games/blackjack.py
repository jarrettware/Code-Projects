...
def main():
    ...
    Rules:
        ...
        but must hit excatly one more time vefore standing.
...
def getHandValue(cards):
    ...
    for card in cards:
        ...
        if rank == 'A':
            ...
            value += int(rank) # Numbered cards are worth tehir numbered
...
def getMove(playerHand, money):
    ...
    while True: # Keep looping until the player enters a correct move.
        ...
        # The player can double down on their first move, which we con
