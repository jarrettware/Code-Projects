...
NUM_DIGITS = 3 # Can increase this to 1-10
MAX_GUESSES = 10 # Can increase this to 1-100
...
def getClues(guess, secretNum):
    ...
    if len(clues) == 0:
        ...
        # Sort the clues into alphabeticalorder so their orginal order
        # doesn't give infomrtino away.
        clues.sort()
